...
> 證據：`api.bls.gov、api.mapbox.com、bchi.bigcitieshealth.org、bost.ocks.org、cdec.water.ca.gov、chartability.github.io、creativecommons.org、cww.water.ca.gov、data.iana.org、data.unicef.org…`

### 🔵 低｜[供應鏈] 有 72 個依賴未鎖定版本

依賴用浮動版號，代表未來自動拉到的新版可能與你稽核過的內容不同。

> 證據：`d3-array@^3.2.4、d3-brush@^3.0.0、d3-chord@^3.0.1、d3-force@^3.0.0、d3-geo@^3.1.0、d3-hierarchy@^3.1.2…`

### 🔵 低｜[權限] 會讀取環境變數（符合宣稱用途）

環境變數常存放 API 金鑰。確認它只讀自己需要的那幾個。「瀏覽器／網頁自動化」類工具本來就需要這個能力，屬預期範圍；重點是你**知情**並給予對應的信任。

> 證據：`.github/workflows/publish-mcp-registry.yml、.github/workflows/release.yml、ai/cli.js、ai/mcp-artifact-contract.integration.test.ts、ai/mcp-build-info.ts`
...
### ⚪ 資訊｜[工具描述投毒] 未發現可疑工具描述（已掃描 514 段 description）
...
⭐ 2702｜fork 139｜語言 TypeScript｜建立 2017-03-16｜最後推送 2026-09-07
