...
> 證據：`api.cloudflare.com、app.slack.com、code.claude.com、evil.example、feross.org、glama.ai、jtalk22.github.io、mcp.revasserlabs.com、opencollective.com、registry.modelcontextprotocol.io…`

### 🔵 低｜[供應鏈] 有 5 個依賴未鎖定版本

依賴用浮動版號，代表未來自動拉到的新版可能與你稽核過的內容不同。

> 證據：`@modelcontextprotocol/node@^2.0.0、@modelcontextprotocol/server@^2.0.0、express@^5.2.1、@modelcontextprotocol/client@^2.0.0、playwright@^1.62.1`
...
⭐ 29｜fork 22｜語言 JavaScript｜建立 2026-01-03｜最後推送 2026-09-03
