...
> 證據：`pkg-pr-new@^0.0.68、supabase@^2.1.1`
...
### ⚪ 資訊｜[工具描述投毒] 未發現可疑工具描述（已掃描 42 段 description）
...
> 證據：`registry 名稱 com.supabase/mcp`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 2922｜fork 408｜語言 TypeScript｜建立 2024-12-20｜最後推送 2026-09-25
