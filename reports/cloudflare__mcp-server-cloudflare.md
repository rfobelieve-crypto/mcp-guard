# MCP 安檢報告：cloudflare/mcp-server-cloudflare
...
> 證據：`npm: @cloudflare/mcp-server-cloudflare（repository 欄位空白）`
...
### ⚪ 資訊｜[工具描述投毒] 未發現可疑工具描述（已掃描 188 段 description）
...
> 證據：`registry 名稱 com.cloudflare.mcp/mcp`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 4224｜fork 522｜語言 TypeScript｜建立 2024-11-27｜最後推送 2026-09-01
