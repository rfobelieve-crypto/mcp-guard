...
> 證據：`package.json、scripts/smoke-mcp.mjs、src/clients/snomed-client.contract.test.ts、src/clients/snomed-client.ts、src/clients/who-client.contract.test.ts`

### 🔵 低｜[權限] 會執行外部指令 / 開子行程（符合宣稱用途）

這個 MCP 能在你的電腦上執行系統指令。「開發框架／工具鏈」類工具本來就需要這個能力，屬預期範圍；重點是你**知情**並給予對應的信任。

> 證據：`scripts/dump-surface.mjs、scripts/gen-lhm-manifest.mjs、scripts/smoke-mcp.mjs`
...
> 證據：`registry 名稱 io.github.SidneyBissoli/medical-terminologies-mcp`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 13｜fork 5｜語言 TypeScript｜建立 2026-01-18｜最後推送 2026-09-23
