# MCP 安檢報告：davidmosiah/samsung-health-mcp
...
> 證據：`scripts/freshness-test.mjs、src/services/connection-status.ts、src/services/incremental-cache.ts、src/services/profile-store.ts、src/services/samsung-health-export.ts`

### 🟡 中｜[權限] 會連往 8 個外部主機

確認這些連線是功能必需的，而不是把你的資料送到第三方。

> 證據：`developer.samsung.com、glama.ai、opencollective.com、smithery.ai、static.modelcontextprotocol.io、support.google.com、wellness.delx.ai、www.samsung.com`

### 🔵 低｜[供應鏈] 有 11 個依賴未鎖定版本

依賴用浮動版號，代表未來自動拉到的新版可能與你稽核過的內容不同。

> 證據：`@modelcontextprotocol/sdk@^1.21.0、cors@^2.8.6、express@^5.2.1、yauzl@^3.2.0、zod@^4.4.3、@types/cors@^2.8.19…`
...
> 證據：`registry 名稱 io.github.davidmosiah/samsung-health-mcp`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 15｜fork 3｜語言 TypeScript｜建立 2026-05-07｜最後推送 2026-09-03
