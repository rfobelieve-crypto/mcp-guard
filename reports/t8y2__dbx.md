...
> 證據：`api.adoptium.net、api.cloudflare.com、api.cnb.cool、api.deepseek.com、api.example.com、api.github.test、cnb.cool、dbx.example.com、dbxio.com、dl.dbxio.com…`
...
### ⚪ 資訊｜[工具描述投毒] 未發現可疑工具描述（已掃描 979 段 description）
...
⭐ 12090｜fork 1150｜語言 Rust｜建立 2026-04-29｜最後推送 2026-07-28
