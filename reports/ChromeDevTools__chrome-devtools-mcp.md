# MCP 安檢報告：ChromeDevTools/chrome-devtools-mcp
...
> 證據：`"prepare": "node scripts/prepare.ts"`
...
> 證據：`a.com、b.com、chromeuxreport.googleapis.com、developer.chrome.com、developers.chrome.com、docs.github.com、eslint.org、feross.org、ffmpeg.org、mobile.web.dev…`
...
> 證據：`.github/workflows/publish-to-npm-on-tag.yml、rollup.config.mjs、scripts/append-lighthouse-notices.ts、scripts/eval_gemini.ts、scripts/generate-cli.ts`
...
> 證據：`registry 名稱 io.github.ChromeDevTools/chrome-devtools-mcp`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 47719｜fork 3225｜語言 TypeScript｜建立 2025-09-11｜最後推送 2026-07-27
