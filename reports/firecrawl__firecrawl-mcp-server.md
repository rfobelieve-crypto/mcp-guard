# MCP 安檢報告：firecrawl/firecrawl-mcp-server
...
> 證據：`api.firecrawl.dev、claude.ai、docs.example.com、docs.firecrawl.dev、eslint.org、example.invalid、firecrawl.dev、glama.ai、mcp.firecrawl.dev、smithery.ai…`

### 🔵 低｜[供應鏈] 有 5 個依賴未鎖定版本

依賴用浮動版號，代表未來自動拉到的新版可能與你稽核過的內容不同。

> 證據：`dotenv@^17.2.2、zod@^4.1.5、@types/node@^24.3.1、tsup@^8.5.0、typescript@^5.9.2`
...
> 證據：`registry 名稱 io.github.firecrawl/firecrawl-mcp-server`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 7061｜fork 821｜語言 JavaScript｜建立 2024-12-06｜最後推送 2026-07-27
