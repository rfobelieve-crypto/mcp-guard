...
> 證據：`apps/android-native/scripts/build-upgrade-harness.mjs、apps/android-native/scripts/capture-parity-screens.mjs、apps/android-native/scripts/check-capture-device.mjs、apps/android-native/scripts/check-editor-device.mjs、apps/android-native/scripts/check-focus-device.mjs`

### 🟡 中｜[權限] 會連往 32 個外部主機

確認這些連線是功能必需的，而不是把你的資料送到第三方。

> 證據：`ai.example.com、aka.ms、androidpublisher.googleapis.com、api.appstoreconnect.apple.com、archive.ubuntu.com、asset.localhost、aur.archlinux.org、azure.archive.ubuntu.com、calendar.example、cloud.test…`
...
⭐ 2122｜fork 132｜語言 TypeScript｜建立 2025-12-08｜最後推送 2026-09-25
