# MCP 安檢報告：rog0x/mcp-docker-tools
...
> 證據：`@modelcontextprotocol/sdk@^1.12.1、@types/node@^22.15.3、typescript@^5.8.3`

### 🔵 低｜[權限] 會執行外部指令 / 開子行程（符合宣稱用途）

這個 MCP 能在你的電腦上執行系統指令。「程式碼／版控工具」類工具本來就需要這個能力，屬預期範圍；重點是你**知情**並給予對應的信任。

> 證據：`src/tools/container-list.ts、src/tools/container-logs.ts、src/tools/image-list.ts`

### 🔵 低｜[權限] 會連往 1 個外部主機

確認這些連線是功能必需的，而不是把你的資料送到第三方。

> 證據：`opencollective.com`
...
> 證據：`registry 名稱 io.github.rog0x/docker`
