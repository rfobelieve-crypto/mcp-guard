# MCP 安檢報告：Grey-Iris/easy-notion-mcp
...
> 證據：`@modelcontextprotocol/sdk@^1.26.0、@notionhq/client@^5.20.0、dotenv@^17.2.3、express@^5.2.1、marked@^17.0.0、@types/express@^5.0.6…`
...
> 證據：`registry 名稱 io.github.misterwigglesworth/easy-notion`

### ⚪ 資訊｜[身分] 倉庫基本資料

⭐ 50｜fork 10｜語言 TypeScript｜建立 2026-03-19｜最後推送 2026-08-12
